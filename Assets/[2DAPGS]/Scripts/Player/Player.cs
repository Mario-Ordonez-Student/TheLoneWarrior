...
public class Player : MonoBehaviour {
    ...
    [HideInInspector]
    public BoxCollider2D checkGroundHelpCollider;
    [HideInInspector]
    ...
    public void Start() {
        ...
        checkGroundHelpCollider = GetComponent<BoxCollider2D>();
        player_animator = GetComponent<Animator>();
        player_rigidbody2d = GetComponent<Rigidbody2D>();
        sfxPlayer = GetComponent<SFXPlayer>();
        itemCountDownScript = GetComponent<GameObject>();
    ...
    public bool meleeTimestart = false;
    public bool meleeTimerReset = false;
    public bool attackTimeStart = false;
    public bool attackTimerReset = false;
    public bool ringTimeStart = false;
    public bool ringTimerReset = false;
    ...
    public void Update() {
        ...
        if (meleeRate == 3.5f)
        {
            ...
            {
                dapercstimeleft = 10f;
                meleeTimestart = false;
            }
            meleetimepassed = Time.deltaTime;
            dapercstimeleft -= meleetimepassed;
            if (dapercstimeleft <= 0f)
            {
                whitebottleend();
            }
        }
    ...
    public void ShootArrow() {
        ...
        arrowGo.GetComponent<Rigidbody2D>().AddForce(transform.right * 325f);
