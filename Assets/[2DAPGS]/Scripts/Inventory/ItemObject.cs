...
public class ItemObject : ScriptableObject {
    ...
    public void HealthAdd() {
        if (Player.instance.currentHealth < 10)
            Player.instance.currentHealth += itemValue;
    }
    ...
    public void EnableInvincibility() {
        ...
        Player.instance.ringTimeStart = true;
        Player.instance.ringTimerReset = true;
    }
    ...
    public void AttackSpeedIncrease() {
        Player.instance.meleeRate = 3.5f;
        Player.instance.meleeTimestart = true;
        Player.instance.meleeTimerReset = true;
    }
    public void Damageboost()
    {
        Player.instance.damage = 10;
        Player.instance.attackTimeStart = true;
        Player.instance.attackTimerReset = true;
    }
